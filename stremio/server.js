...
<style>
:root{color-scheme:dark;--bg:#060606;--panel:#121212;--panel2:#191919;--line:#2a2a2a;--text:#fff;--muted:#b3b3b3;--red:#e50914;--red2:#b20710;--green:#22c55e}
...
body:before{content:"";position:fixed;inset:0;background:radial-gradient(circle at 20% 0%,rgba(229,9,20,.24),transparent 34%),linear-gradient(180deg,rgba(0,0,0,.2),#060606 58%);pointer-events:none}
main{position:relative;z-index:1;width:min(1280px,calc(100% - 32px));margin:0 auto;padding:22px 0 56px}
.nav{height:54px;display:flex;align-items:center;justify-content:space-between;gap:16px}.brand{font-weight:900;font-size:24px;color:var(--red);letter-spacing:0}.navlinks{display:flex;gap:10px;flex-wrap:wrap}.navlinks a{color:#eee;text-decoration:none;font-weight:700;font-size:14px;padding:8px 10px;border-radius:6px}.navlinks a:hover{background:#1f1f1f}
.hero{display:grid;grid-template-columns:minmax(0,1.22fr) minmax(340px,.78fr);gap:22px;align-items:stretch;margin-top:14px}.player{position:relative;background:#000;border-radius:8px;overflow:hidden;box-shadow:0 24px 90px rgba(0,0,0,.55)}video{display:block;width:100%;height:100%;min-height:430px;max-height:68vh;background:#000;object-fit:contain}.shade{position:absolute;inset:auto 0 0 0;padding:22px 22px 52px;background:linear-gradient(0deg,rgba(0,0,0,.9),transparent);pointer-events:none}.shade h1{font-size:clamp(30px,5vw,58px);line-height:1;margin:0 0 8px}.shade p{margin:0;color:var(--muted);max-width:720px}
.side{display:flex;flex-direction:column;gap:14px}.searchBox,.now,.streamsPanel,.logPanel{background:rgba(18,18,18,.92);border:1px solid var(--line);border-radius:8px;padding:14px}.searchGrid{display:grid;grid-template-columns:1fr 110px;gap:10px}input,select,button{font:inherit;min-height:42px;border-radius:6px;border:1px solid #333}input,select{background:#0a0a0a;color:#fff;padding:0 12px}button{border:0;background:var(--red);color:white;font-weight:800;padding:0 14px;cursor:pointer}button:hover{background:var(--red2)}button.secondary{background:#2a2a2a}button.ghost{background:#050505;border:1px solid #333}.searchBtn{width:100%;margin-top:10px}
...
.streamGrid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}.stream{min-height:86px;text-align:left;background:#141414;border:1px solid #292929;border-radius:8px;color:#fff;padding:12px}.stream.active{border-color:var(--green);box-shadow:0 0 0 1px var(--green)}.stream strong{display:block;font-size:15px}.stream small{display:block;color:var(--muted);font-weight:400;font-size:12px;margin-top:5px}.pill{display:inline-flex;align-items:center;min-height:22px;padding:0 8px;border-radius:999px;background:#2a2a2a;color:#fff;font-size:11px;font-weight:900;margin-top:7px}.pill.mp4{background:#14532d}.pill.hls{background:#7f1d1d}
